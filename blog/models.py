...
class Ad(models.Model):
    ...
    image_url = models.ImageField(upload_to='ad/%Y/%m',max_length=100,verbose_name='图片路径')
...
class Comment(models.Model):
    ...
    username=models.CharField(max_length=30,blank=True,null=True,verbose_name='用户名名')
